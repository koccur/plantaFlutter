    ...
    return AppBar(
        ...
        actions: <Widget>[
          IconButton(
              ...
              onPressed: () async {
                if (_plant.id != null) {
                  await PlantController.updatePlant(_plant).whenComplete(() => Navigator.pop(context));
                } else {
                  await PlantController.createPlant(_plant).whenComplete(() => Navigator.pop(context));
                }
              }),
        ]);
  }
